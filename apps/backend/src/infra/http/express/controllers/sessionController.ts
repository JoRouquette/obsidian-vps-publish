...
import { SessionInvalidError, SessionNotFoundError } from '../../../../domain/errors/SessionError';
...
import { UploadAssetsCommand } from '../../../../application/publishing/commands/UploadAssetsCommand';
